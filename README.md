...
-   **Surface detection** with dotted plane feedback and a placement
    reticle
...
The repository includes an [`example/`](example/) React/Vite application
demonstrating:
...
-   [`INSTALLATION.md`](docs/INSTALLATION.md) --- installation and
    integration
-   [`PHONE_TESTING.md`](docs/PHONE_TESTING.md) --- physical-device
    testing
-   [`HTTPS_SETUP.md`](docs/HTTPS_SETUP.md) --- local HTTPS and LAN
    setup
